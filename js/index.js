...
const texts = [
  ...
  'NodeJS', 'OCaml', 'Redux', 'Rx', 'Javascript',
];
...
const popupOpenButton = document.querySelector('.form__button')
...
popupOpenButton.addEventListener('mousedown', () => {
  openPopup(popup)
})

popupCloseButton.addEventListener('mousedown', () => {
  closePopup(popup)
})
